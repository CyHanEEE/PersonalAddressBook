...
public class Client extends JFrame {
    ...
    public void personList(List<String> mes) {
        String[][] data;
        if (mes == null) data = dataManager.getContacts(null, null, null);
        else data = dataManager.getContacts(mes.get(0), mes.get(1), mes.get(2));
                ...
                if ("删除".equals(value)) {
                    ...
                    if (choose == JOptionPane.YES_OPTION) {
                        try {
                            ...
                            client.dataManager.deleteContact(id);
